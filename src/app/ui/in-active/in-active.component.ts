...
export class InActiveComponent implements OnInit {
  ...
  constructor(public auth: AuthService,public econtractService: EcontractService , public router: Router) { }
  ...
  ngOnInit() {
    ...
    this.econtractService.getUsersAllSC(0).subscribe(
      (list) => {
        console.log(list);
    ...
    this.econtractService.getUsersAllSP(0).subscribe(
      (list) => {
        console.log(list);
  ...
  uiDataAdderSP(){
    ...
    for(var i =0 ; i < this.SPecontracts.length; i++){
      ...
      if(status == 0){
        ...
        this.SPecontracts[i].statusMessage = "Contract was cancelled in between ! 50% will be given";
        this.SPecontracts[i].logoUrl = this.logoBase + "red_c.svg";
      }else if(status == 13){
        this.SPecontracts[i].statusMessage = "Contract was cancelled after the session ! 50% will be given";
        this.SPecontracts[i].logoUrl = this.logoBase + "red_c.svg";
      }else if(status == 14){
        this.SPecontracts[i].statusMessage = "Contract was cancelled by Paylancer ! 50% will be given";
        this.SPecontracts[i].logoUrl = this.logoBase + "red_c.svg";
      }
